...
export default function Page() {
  ...
  return (
    <>
      <section className="px-4 py-12 md:px-12 md:py-12 lg:px-32 lg:py-24 flex flex-col gap-12 md:gap-0 items-center justify-center text-center">
        ...
        <p className="text-quaternary mt-12">
          Big Bus adalah solusi bagi perjalanan wisata keluarga, ziarah, study
          tour, kunjungan kerja, antar jemput karyawan dan berbagai keperluan
          perjalanan lainnya yang menghajatkan kapasitas penumpang yang besar.
          Fasilitas yang lengkap dan terawat adalah usaha kami untuk memastikan
          perjalanan anda selalu istimewa.
        </p>
      </section>
      <section className="px-4 py-12 md:px-12 md:py-12 lg:px-32 lg:pt-8 lg:pb-24 flex flex-col gap-12 md:gap-0 items-center justify-center">
        ...
        <div className="w-full mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {armadaList
            .filter((armada) => {
              if (filterArmada === "" && searchQuery === "") {
                return armada
              }

              if (
                armada.name.toLowerCase().includes(searchQuery.toLowerCase()) &&
                filterArmada === ""
              ) {
                return armada
              }
              ...
              if (
                armada.name.toLowerCase().includes(searchQuery.toLowerCase()) &&
                armada.size.toLowerCase().includes(filterArmada.toLowerCase())
              ) {
                return armada
              }
            })
        ...
        {armadaList.length > 0 &&
          armadaList.filter((armada) => {
            ...
            <p className="text-lg text-quaternary text-center w-full">
