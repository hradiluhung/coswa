...
import { ArrowLeftCircle, Users } from "react-feather"
    ...
    <section className="px-4 py-12 md:px-12 md:py-12 lg:px-32 lg:py-24 flex flex-col gap-12 md:gap-0">
      ...
      <div className="grid grid-cols-4 gap-8 mt-12">
        <Image
          ...
          src={armada.image}
          alt="stack-card-bg"
          className="object-cover rounded-xl w-full h-full col-span-2 row-span-2"
        />
        <Image
          width={200}
          height={200}
          src={armada.image}
          alt="stack-card-bg"
          className="object-cover rounded-xl w-full h-full col-span-1"
        />
        <Image
          width={200}
          height={200}
      ...
      <div className="w-full mt-12 gap-12 justify-between items-start flex">
        <div className="basis-2/3">
          ...
          <ul className="flex flex-col gap-4 mt-4 list-disc pl-6">
            ...
            <li>
              <p className="text-lg">
                Apabila terjadi perubahan jadwal diharapkan untuk mengkonfirmasi
                kepada kami paling lambat 8 hari sebelum keberangkatan.
              </p>
            </li>
          </ul>
        </div>
